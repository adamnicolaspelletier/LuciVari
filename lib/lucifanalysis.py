...
# 					help="Luciferase readings in a .txt file. 'Defaults to ../media/documents/lucif_raw.txt'", default= str(cwd)+"../media/documents/lucif_raw.txt")
...
def lucifanalysis_report(rawtemp, pdf, outputfile):
	""" Generates a report from a luciferase experiment, with the option of also generating a PDF figure report if pdf argument is set to 'True'."""
